...
public class TrailRendererWithCollider : MonoBehaviour
{
    ...
    /// </summary>
    public void ChangeTrailMaterial(Material a_material)
    {
        trailMaterial = a_material;
        //collider.renderer.material = material;
        gasCollider.GetComponent<Renderer>().material = a_material;
    }
    ...
    public void ChangeColliderTrigger(bool isTrigger)
    {
        ...
        gasCollider.isTrigger = isTrigger;
    }
    ...
    private void Awake()
    {
        ...
        gasCollider = trail.GetComponent<PolygonCollider2D>();
        gasCollider.isTrigger = colliderIsTrigger;
        gasCollider.SetPath(0, null);
    ...
    private void SetMesh()
    {
        ...
        if (colliderEnabled)
        {
            gasCollider.SetPath(0, colliderPath);
        }
    }
    ...
    //    {
    //        Debug.Log("This fart is being smelled by an NPC!");
    //    }
    //}
